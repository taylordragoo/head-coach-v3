...
<template>
    <section class="animate-fadein animate-duration-300 animate-ease-in landing-container mx-auto min-h-[75vh] lg:min-h-screen flex flex-col items-center justify-center">
        <LazyImage class="w-[15rem]" :src="'/demo/images/landing/access-denied.png'" alt="404 Image" />
        ...
        <router-link to="/" class="body-button bg-violet-600 w-fit mt-8 hover:bg-violet-500 px-4">Go to Dashboard</router-link>
    </section>
</template>

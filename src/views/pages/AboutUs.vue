...
<template>
    <div>
        <LazyImage class-name="max-w-[80rem] mx-auto max-h-[32rem] h-full w-full object-cover rounded-2xl" src="/demo/images/dashboard/about-us-image.jfif" />
        <div class="mt-12 max-w-[52rem] mx-auto pb-12">
            <h3 class="title-h4 text-left">About us</h3>
            <p class="body-large text-left font-normal mt-6">

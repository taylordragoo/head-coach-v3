                    ...
                    <div class="col-span-12 mt-4">
                        ...
                        >
                            <template v-if="uploadFiles.length > 0" #content>
                                <div class="h-80 m-1 py-3 rounded">
                                    <div v-for="file in uploadFiles" :key="file.name" class="w-full h-full relative rounded p-0" :style="{ cursor: 'copy' }">
                                        <div class="remove-file-wrapper group relative w-full h-full border-4 border-transparent rounded hover:bg-primary hover:text-primary-contrast duration-100 cursor-auto">
                                            <img :src="file.objectURL" :alt="file.name" class="w-full h-full rounded group-hover:shadow" />
                                            <Button
                                                icon="pi pi-times"

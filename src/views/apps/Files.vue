...
chartData.value = {
    datasets: [
        {
            data: [300, 100],
            backgroundColor: [documentStyle.getPropertyValue('--p-primary-400'), documentStyle.getPropertyValue('--p-primary-100')],
            hoverBackgroundColor: [documentStyle.getPropertyValue('--p-primary-600'), documentStyle.getPropertyValue('--p-primary-200')],
        ...
        <div class="col-span-12 md:col-span-5 xl:col-span-3">
            ...
            <div class="card">
                ...
                <ul class="list-none p-0 m-0">
                    <li class="p-4 mb-4 flex items-center justify-between cursor-pointer rounded bg-indigo-50 dark:bg-indigo-500/20 text-indigo-900 dark:text-indigo-200">
                    ...
                    <li class="p-4 mb-4 flex items-center justify-between cursor-pointer rounded bg-purple-50 dark:bg-purple-500/20 text-purple-900 dark:text-purple-200">
                        <div class="flex items-center">
                    ...
                    <li class="p-4 flex items-center justify-between cursor-pointer rounded bg-teal-50 dark:bg-teal-500/20 text-teal-900 dark:text-teal-200">
                        <div class="flex items-center">
                        ...
                        <template #content>
                            <div v-if="uploadFiles.length > 0" class="w-full py-4" :style="{ cursor: 'copy' }">
                                <div v-for="file in uploadFiles" :key="file.name" class="flex flex-wrap gap-8">
                                    <div class="remove-file-wrapper group relative w-28 h-28 border-4 border-transparent rounded hover:bg-primary hover:text-primary-contrast duration-100 cursor-auto" :style="{ padding: '1px' }">
                                        <img :src="file.objectURL" :alt="file.name" class="w-full h-full rounded object-contain group-hover:shadow" />
                                        <Button
                                            icon="pi pi-times"

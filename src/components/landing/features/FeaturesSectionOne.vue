    ...
    <section class="landing-container relative py-12 lg:py-24">
        <div class="max-w-[68rem] mx-auto flex lg:flex-row flex-col items-center gap-14 xl:gap-20">
            <div class="relative lg:flex-1 h-[27rem] lg:h-[34.6rem] w-full max-w-[25rem] lg:max-w-[32rem]">
                <LazyImage
                    class="w-[19rem] lg:w-[24rem] z-0 rounded-2xl delay-300 h-auto absolute rotate-[-22deg] bottom-10 lg:bottom-12 left-12 lg:left-16 shadow-[0px_20px_52px_0px_rgba(0,0,0,0.04),0px_112px_31px_0px_rgba(0,0,0,0.00),0px_72px_29px_0px_rgba(0,0,0,0.01)]"
                    :src="'/demo/images/landing/boxes/' + (isDarkTheme ? 'spending-limit-dark.png' : 'spending-limit.png')"
                    alt="Features Section One Box Image"
                />
                <LazyImage
                    class="w-[18rem] lg:w-[23rem] rounded-2xl z-10 h-auto absolute top-0 right-0 shadow-[0px_20px_52px_0px_rgba(0,0,0,0.04),0px_112px_31px_0px_rgba(0,0,0,0.00),0px_72px_29px_0px_rgba(0,0,0,0.01)]"

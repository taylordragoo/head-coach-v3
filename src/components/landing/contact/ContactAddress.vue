...
<template>
    <section class="landing-container mx-auto py-10 lg:py-20">
        <div class="max-w-xl lg:max-w-6xl mx-auto flex lg:flex-row flex-col gap-7">
            <div v-for="(data, index) of contactInfo" :key="index" class="flex-1 p-3.5 rounded-3xl border border-surface-200 dark:border-surface-800 shadow-[0px_1px_2px_0px_rgba(18,18,23,0.05)]">
                <LazyImage className="max-h-96 w-full h-full object-cover rounded-2xl shadow-[0px_1px_2px_0px_rgba(69,69,69,0.24),0px_0px_0px_1px_rgba(71,71,71,0.08)]" :src="data.image" alt="Contact Address Image" />

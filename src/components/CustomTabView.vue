<template>
    <div :class="contentClasses" v-bind="ptm('root')">
        <div class="p-tabview-nav-container" v-bind="ptm('navcontainer')">
            ...
            >
                <slot name="previcon">
                    <component :is="prevIcon ? 'span' : 'pi-chevron-left'" aria-hidden="true" :class="prevIcon" v-bind="ptm('previcon')" />
                </slot>
            </button>
            ...
            >
                <slot name="nexticon">
                    <component :is="nextIcon ? 'span' : 'pi-chevron-right'" aria-hidden="true" :class="nextIcon" v-bind="ptm('nexticon')" />
                </slot>
            </button>
        </div>
...
import { DomHandler, UniqueComponentId } from '@/lib/utils';

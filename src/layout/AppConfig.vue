                    ...
                    <div class="flex flex-wrap flex-col gap-3">
                        <div class="flex">
                            <div class="flex items-center gap-2 w-6/12">
                                <RadioButton name="menuMode" value="static" v-model="menuMode" @update:modelValue="handleSetMenuMode" inputId="mode1" />
                                <label for="mode1">Static</label>
                            </div>

                            <div class="flex items-center gap-2 w-6/12">
                                <RadioButton name="menuMode" value="overlay" v-model="menuMode" @update:modelValue="handleSetMenuMode" inputId="mode2" />
                                <label for="mode2">Overlay</label>
                            </div>
                        </div>
                        <div class="flex">
                            <div class="flex items-center gap-2 w-6/12">
                                <RadioButton name="menuMode" value="slim" v-model="menuMode" @update:modelValue="handleSetMenuMode" inputId="mode3" />
                                <label for="mode2">Slim</label>
                            </div>
                            <div class="flex items-center gap-2 w-6/12">
                                <RadioButton name="menuMode" value="compact" v-model="menuMode" @update:modelValue="handleSetMenuMode" inputId="mode4" />
                                <label for="mode3">Compact</label>
                            </div>
                        </div>
                        <div class="flex">
                            <div class="flex items-center gap-2 w-6/12">
                                <RadioButton name="menuMode" value="reveal" v-model="menuMode" @update:modelValue="handleSetMenuMode" inputId="mode5" />
                                <label for="mode4">Reveal</label>
                            </div>
                            <div class="flex items-center gap-2 w-6/12">
                                <RadioButton name="menuMode" value="drawer" v-model="menuMode" @update:modelValue="handleSetMenuMode" inputId="mode6" />
                                <label for="mode5">Drawer</label>
                            </div>
                        </div>
                        <div class="flex">
                            <div class="flex items-center gap-2 w-6/12">
                                <RadioButton name="menuMode" value="horizontal" v-model="menuMode" @update:modelValue="handleSetMenuMode" inputId="mode2" />
